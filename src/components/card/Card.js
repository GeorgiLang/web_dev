...
const  Card = props => {
    ...
    return (
        <div className={s.wrapper}>
            <div className={`${s.card} ${card.acf.in_stock === 'Есть в наличии' ? null : s.stock}`}>
                {card.acf.in_stock !== 'Есть в наличии' && <p className={s.warning}>{card.acf.in_stock}</p>}
                ...
                <ProductDescription className={s.description} description={'description'} card={card}/>
            </div>
        </div>
    )
}
